...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($event_date) || empty($event_time) || empty($venue)) {
        ...
        if ($stmt->execute()) {
            $success = 'Wedding event created successfully!';
...
<head>
    ...
    <title>Plan Wedding Event - Event Management</title>
    <meta name="description" content="Plan your dream wedding celebration">
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <p style="color: var(--text-secondary); font-size: 1.2rem;">
                    Create the perfect celebration of love and commitment
                </p>
            </div>
            ...
            <div class="card">
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        <label for="event_name" class="form-label">Couple Names *</label>
                        <input 
                            type="text" 
                            id="event_name" 
                            name="event_name" 
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                        <div class="form-group">
                            <label for="event_date" class="form-label">Wedding Date *</label>
                            <input 
                                type="date" 
                                id="event_date" 
                                name="event_date" 
                        ...
                        <div class="form-group">
                            <label for="event_time" class="form-label">Ceremony Time *</label>
                            <input 
                                type="time" 
                                id="event_time" 
                                name="event_time" 
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            name="venue" 
                            class="form-input" 
                            placeholder="e.g., St. Mary's Church & Grand Hotel Ballroom"
                            required
                    ...
                    <div class="form-group">
                        <label for="description" class="form-label">Wedding Details</label>
                        <textarea 
                            id="description" 
                            name="description" 
                            class="form-input" 
                            placeholder="Add details about theme, color scheme, special requirements, dietary restrictions, etc..."
                            rows="5"
