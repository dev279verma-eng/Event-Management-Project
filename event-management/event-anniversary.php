...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($event_date) || empty($event_time) || empty($venue)) {
        ...
        if ($stmt->execute()) {
            $success = 'Anniversary event created successfully!';
...
<head>
    ...
    <title>Plan Anniversary - Event Management</title>
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <p style="color: var(--text-secondary); font-size: 1.2rem;">
                    Celebrate love and togetherness with a memorable event
                </p>
            </div>
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" id="event_name" name="event_name" class="form-input" 
                               placeholder="e.g., Our 10th Anniversary" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="venue" name="venue" class="form-input" 
                               placeholder="e.g., Romantic Restaurant, Beach Resort" required
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-input" rows="5"
                                  placeholder="Add special memories, themes, or celebration details..."
