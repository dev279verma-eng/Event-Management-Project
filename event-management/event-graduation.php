...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($event_date) || empty($event_time) || empty($venue)) {
        ...
        if ($stmt->execute()) {
            $success = 'Graduation event created successfully!';
...
<head>
    ...
    <title>Plan Graduation - Event Management</title>
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <p style="color: var(--text-secondary); font-size: 1.2rem;">
                    Honor achievement and success with a special celebration
                </p>
            </div>
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" id="event_name" name="event_name" class="form-input" 
                               placeholder="e.g., Class of 2026 Graduation Party" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="venue" name="venue" class="form-input" 
                               placeholder="e.g., University Hall, Family Home" required
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="budget" name="budget" class="form-input" 
                                   placeholder="e.g., 4000" min="0" step="0.01"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-input" rows="5"
                                  placeholder="Add graduation details, degree/program, color theme, special activities..."
