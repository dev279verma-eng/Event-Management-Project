...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($event_name) || empty($event_date) || empty($event_time) || empty($venue)) {
        ...
        if ($stmt->execute()) {
            $success = 'Birthday event created successfully!';
...
<head>
    ...
    <title>Plan Birthday Event - Event Management</title>
    <meta name="description" content="Plan an amazing birthday celebration">
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="text-align: center; margin-bottom: 3rem;">
                ...
                <p style="color: var(--text-secondary); font-size: 1.2rem;">
                    Create an unforgettable birthday celebration
                </p>
            </div>
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            name="venue" 
                            class="form-input" 
                            placeholder="e.g., The Grand Ballroom, 123 Main Street"
                            required
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            name="description" 
                            class="form-input" 
                            placeholder="Add any special details, themes, or requirements..."
                            rows="5"
